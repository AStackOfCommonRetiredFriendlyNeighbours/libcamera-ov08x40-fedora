...
# OV08X40/IPU6 patch set; see docs/patch-provenance.md in the repository.
Patch02: 0002-simple-adjust-tuning.patch
# Local adaptation of the Patchwork AGC change to Fedora 44's 0.7.1 AGC.
Patch03: 0003-simple-agc-tuning-f44-backport.patch
Patch04: 0004-ov08x40-spectre-tuning.patch
Patch05: 0005-ov08x40-sensor-helper.patch
